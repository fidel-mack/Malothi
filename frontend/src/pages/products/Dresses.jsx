...
const products = [
  { id: 1, name: "Summer Dress", price: "$59.99", image: "👗" },
  { id: 2, name: "Evening Gown", price: "$129.99", image: "👗" },
  { id: 3, name: "Casual Sundress", price: "$49.99", image: "👗" },
  { id: 4, name: "Maxi Dress", price: "$79.99", image: "👗" },
  { id: 5, name: "Party Dress", price: "$89.99", image: "👗" },
  { id: 6, name: "Cocktail Dress", price: "$99.99", image: "👗" },
  { id: 7, name: "Boho Dress", price: "$69.99", image: "👗" },
  { id: 8, name: "Work Dress", price: "$74.99", image: "👗" },
  { id: 9, name: "Floral Dress", price: "$64.99", image: "👗" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      ...
      <div className="flex gap-4 p-6 max-w-7xl mx-auto border-b border-gray-700">
        ...
        <Link to="/dresses" className="px-4 py-2 bg-purple-600 rounded-lg">Dresses</Link>
      ...
      <section className="py-12 px-6 max-w-7xl mx-auto">
        <h1 className="text-5xl font-bold mb-2">👗 Dresses</h1>
        <p className="text-gray-300 text-lg">Beautiful dresses for every occasion and style</p>
      </section>
      ...
      <section className="px-6 pb-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            <div
              key={product.id}
              className="group relative overflow-hidden rounded-lg border border-gray-700 hover:border-purple-500 transition bg-gray-800/50 hover:bg-gray-800 cursor-pointer"
            >
              <div className="h-48 flex items-center justify-center text-6xl bg-gradient-to-br from-purple-600/20 to-pink-600/20">
                {product.image}
              </div>
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button 
                    ...
                    className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded transition text-sm"
                  >
                    Add to Cart
                  </button>
                </div>
